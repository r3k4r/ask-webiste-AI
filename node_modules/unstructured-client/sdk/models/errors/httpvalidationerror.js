...
/** @internal */
exports.Detail$inboundSchema = z.union([
    z.array(shared.ValidationError$inboundSchema),
    z.string(),
]);
/** @internal */
exports.Detail$outboundSchema = z.union([
...
/** @internal */
exports.HTTPValidationError$inboundSchema = z
    .object({
...
/** @internal */
exports.HTTPValidationError$outboundSchema = z
